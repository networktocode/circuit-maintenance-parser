...
```no-highlight
> poetry version
circuit-maintenance-parser 1.0.0-beta.2
```
...
Draft a [new release](https://github.com/networktocode/circuit-maintenance-parser/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @ntc_user in https://github.com/networktocode/circuit-maintenance-parser/pull/123` -> `* @ntc_user`.
...
**Full Changelog**: https://github.com/networktocode/circuit-maintenance-parser/compare/v1.4.1...v1.4.2
```
