"""Validate circuit_maintenance_parser logging works."""
...
def test_initialize_logging_default(get_logger, basic_cfg):
    ...
    circuit_maintenance_parser.log.initialize_logging()
    ...
    assert get_logger.mock_calls[0].args == ("circuit_maintenance_parser",)
...
def test_initialize_logging_user_defined_config(get_logger, basic_cfg):
    ...
    circuit_maintenance_parser.log.initialize_logging(config=config)
...
def test_initialize_logging_filename(get_logger, basic_cfg):
    ...
    circuit_maintenance_parser.log.initialize_logging(filename="output.log")
